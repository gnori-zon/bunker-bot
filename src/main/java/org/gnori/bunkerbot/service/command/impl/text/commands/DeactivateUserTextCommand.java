...
public class DeactivateUserTextCommand implements TextCommand {
    ...
    public void execute(Update update) {
        ...
        botUserStateChanger.changeState(chatId, BotUserState.WAITING_DEACTIVATE_ID);
    }

    @Override
    public TextCommandKey getSupportedKey() {
        return TextCommandKey.DEACTIVATE_USER;
    }
}
