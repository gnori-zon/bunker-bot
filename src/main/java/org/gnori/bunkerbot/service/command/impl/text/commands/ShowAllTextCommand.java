...
public class ShowAllTextCommand implements TextCommand {
    ...
    public void execute(Update update) {
        ...
        final List<BotUser> botUsers = botUserRepository.findAll();
    ...
    public TextCommandKey getSupportedKey() {
        return TextCommandKey.SHOW_ALL;
    }
    ...
    private void sendUserInfo(long chatId, BotUser botUser) {
        ...
        final String userInfo = String.format(
                ResponseConst.USER_INFO_PATTERN,
                botUser.getId(), botUser.getUsername(), botUser.isActive()
        );
